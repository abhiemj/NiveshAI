...
class ProfessionalEquityReport:
    ...
    def build_disclaimer_page(self):
        ...
        # 报告信息
        report_info = f"Report Generated: {datetime.now(EASTERN_TZ).strftime('%Y-%m-%d %H:%M')} ET | {self.data.get('research_source', 'Nivesh AI · Built on FinRobot (Apache 2.0)')}"
    ...
    def _add_pdf_metadata(self, canvas_obj, doc):
        ...
        canvas_obj.setAuthor(self.data.get('research_source', 'Nivesh AI · Built on FinRobot (Apache 2.0)'))
        ...
        canvas_obj.setCreator('Nivesh AI Equity Research Platform (built on FinRobot)')
